...
@ddt
class Test_Batchlogin(unittest.TestCase, Driver, PenCenterPage, Test_Loginpage, Home_Operation):
    ...
    def tearDown(self):
        ...
        self.driver.quit()
    # a = Read_data.read_text("D:\\java\\Python\\py_workspace\\data\\RW_logins")
